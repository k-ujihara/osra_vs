...
{
	std::string input_file(ptr_input_file);
	std::string output_file(ptr_output_file);
	std::string output_format(ptr_output_format);
	std::string embedded_format(ptr_embedded_format);
	std::string osra_dir(ptr_osra_dir);
	std::string spelling_file(ptr_spelling_file);
	std::string superatom_file(ptr_superatom_file);
	std::string output_image_file_prefix(ptr_output_image_file_prefix);
	std::string resize(ptr_resize);
	std::string preview(ptr_preview);
