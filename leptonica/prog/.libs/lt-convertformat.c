...
/* ./.libs/lt-convertformat.c - temporary wrapper executable for .libs/convertformat.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The convertformat program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "convertformat.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# convertformat - temporary wrapper script for .libs/convertformat.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The convertformat program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"convertformat.exe:convertformat:${LINENO}: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.2 Debian-2.4.2-1ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"convertformat.exe:convertformat:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"convertformat.exe:convertformat:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='convertformat.exe'\n", f);
