...
/* ./.libs/lt-convertsegfilestopdf.c - temporary wrapper executable for .libs/convertsegfilestopdf.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The convertsegfilestopdf program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = ""c:\\Users\\ujiha\\Documents\\Visual Studio 2015\\Projects\\leptonica\\src\\.libs";";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "\\c\\Users\\ujiha\\Documents\\Visual:Studio:2015\\Projects\\leptonica\\src\\.libs:\\usr\\local\\lib:\\usr\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "convertsegfilestopdf.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# convertsegfilestopdf - temporary wrapper script for .libs/convertsegfilestopd", f);
  fputs ("f.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The convertsegfilestopdf program cannot be directly executed until all the li", f);
  fputs ("btool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/liblept.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"convertsegfilestopdf.exe:convertsegfilestopdf:${LINENO}: libtool wrap", f);
  fputs ("per (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"convertsegfilestopdf.exe:convertsegfilestopdf:${LINENO}: newargv[$lt", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"convertsegfilestopdf.exe:convertsegfilestopdf:${LINENO}: newargv", f);
  ...
  fputs ("\n", f);
  fputs ("  program='convertsegfilestopdf.exe'\n", f);
  ...
  fputs ("    PATH=/c/Users/ujiha/Documents/Visual:Studio:2015/Projects/leptonica/src/.li", f);
  fputs ("bs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/ujiha/Documents/Visual Studio 2015/Projects/leptonica/src/.l", f);
  fputs ("ibs:$PATH\"\n", f);
  fputs ("\n", f);
