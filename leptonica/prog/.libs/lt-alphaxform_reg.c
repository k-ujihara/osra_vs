...
/* ./.libs/lt-alphaxform_reg.c - temporary wrapper executable for .libs/alphaxform_reg.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The alphaxform_reg program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "alphaxform_reg.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# alphaxform_reg - temporary wrapper script for .libs/alphaxform_reg.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The alphaxform_reg program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"alphaxform_reg.exe:alphaxform_reg:${LINENO}: libtool wrapper (GNU lib", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"alphaxform_reg.exe:alphaxform_reg:${LINENO}: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"alphaxform_reg.exe:alphaxform_reg:${LINENO}: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='alphaxform_reg.exe'\n", f);
