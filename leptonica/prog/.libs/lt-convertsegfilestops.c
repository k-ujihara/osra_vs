...
/* ./.libs/lt-convertsegfilestops.c - temporary wrapper executable for .libs/convertsegfilestops.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The convertsegfilestops program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "convertsegfilestops.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# convertsegfilestops - temporary wrapper script for .libs/convertsegfilestops.", f);
  fputs ("exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The convertsegfilestops program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"convertsegfilestops.exe:convertsegfilestops:${LINENO}: libtool wrappe", f);
  fputs ("r (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"convertsegfilestops.exe:convertsegfilestops:${LINENO}: newargv[$lt_d", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"convertsegfilestops.exe:convertsegfilestops:${LINENO}: newargv[0", f);
  ...
  fputs ("\n", f);
  fputs ("  program='convertsegfilestops.exe'\n", f);
