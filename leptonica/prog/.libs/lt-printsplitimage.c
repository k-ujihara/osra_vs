...
/* ./.libs/lt-printsplitimage.c - temporary wrapper executable for .libs/printsplitimage.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The printsplitimage program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "printsplitimage.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# printsplitimage - temporary wrapper script for .libs/printsplitimage.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The printsplitimage program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"printsplitimage.exe:printsplitimage:${LINENO}: libtool wrapper (GNU l", f);
  fputs ("ibtool) 2.4.2 Debian-2.4.2-1ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"printsplitimage.exe:printsplitimage:${LINENO}: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"printsplitimage.exe:printsplitimage:${LINENO}: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='printsplitimage.exe'\n", f);
