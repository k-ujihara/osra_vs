...
/* ./.libs/lt-convertfilestopdf.c - temporary wrapper executable for .libs/convertfilestopdf.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The convertfilestopdf program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "convertfilestopdf.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# convertfilestopdf - temporary wrapper script for .libs/convertfilestopdf.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The convertfilestopdf program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"convertfilestopdf.exe:convertfilestopdf:${LINENO}: libtool wrapper (G", f);
  fputs ("NU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"convertfilestopdf.exe:convertfilestopdf:${LINENO}: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"convertfilestopdf.exe:convertfilestopdf:${LINENO}: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='convertfilestopdf.exe'\n", f);
