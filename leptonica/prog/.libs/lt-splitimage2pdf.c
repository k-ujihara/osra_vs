...
/* ./.libs/lt-splitimage2pdf.c - temporary wrapper executable for .libs/splitimage2pdf.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The splitimage2pdf program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "splitimage2pdf.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# splitimage2pdf - temporary wrapper script for .libs/splitimage2pdf.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The splitimage2pdf program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"splitimage2pdf.exe:splitimage2pdf:${LINENO}: libtool wrapper (GNU lib", f);
  fputs ("tool) 2.4.2 Debian-2.4.2-1ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"splitimage2pdf.exe:splitimage2pdf:${LINENO}: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"splitimage2pdf.exe:splitimage2pdf:${LINENO}: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='splitimage2pdf.exe'\n", f);
