...
/* ./.libs/lt-convertfilestops.c - temporary wrapper executable for .libs/convertfilestops.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The convertfilestops program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "convertfilestops.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# convertfilestops - temporary wrapper script for .libs/convertfilestops.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The convertfilestops program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"convertfilestops.exe:convertfilestops:${LINENO}: libtool wrapper (GNU", f);
  fputs (" libtool) 2.4.2 Debian-2.4.2-1ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"convertfilestops.exe:convertfilestops:${LINENO}: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"convertfilestops.exe:convertfilestops:${LINENO}: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='convertfilestops.exe'\n", f);
