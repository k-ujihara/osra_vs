...
/* ./.libs/lt-alphaops_reg.c - temporary wrapper executable for .libs/alphaops_reg.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The alphaops_reg program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "alphaops_reg.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# alphaops_reg - temporary wrapper script for .libs/alphaops_reg.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The alphaops_reg program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"alphaops_reg.exe:alphaops_reg:${LINENO}: libtool wrapper (GNU libtool", f);
  fputs (") 2.4.2 Debian-2.4.2-1ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"alphaops_reg.exe:alphaops_reg:${LINENO}: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"alphaops_reg.exe:alphaops_reg:${LINENO}: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='alphaops_reg.exe'\n", f);
