...
/* ./.libs/lt-converttops.c - temporary wrapper executable for .libs/converttops.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The converttops program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "converttops.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# converttops - temporary wrapper script for .libs/converttops.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The converttops program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"converttops.exe:converttops:${LINENO}: libtool wrapper (GNU libtool) ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"converttops.exe:converttops:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"converttops.exe:converttops:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
