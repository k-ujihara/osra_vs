...
/* ./.libs/lt-converttopdf.c - temporary wrapper executable for .libs/converttopdf.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1

   The converttopdf program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "converttopdf.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# converttopdf - temporary wrapper script for .libs/converttopdf.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The converttopdf program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"converttopdf.exe:converttopdf:${LINENO}: libtool wrapper (GNU libtool", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"converttopdf.exe:converttopdf:${LINENO}: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"converttopdf.exe:converttopdf:${LINENO}: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='converttopdf.exe'\n", f);
